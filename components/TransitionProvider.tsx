  ...
  return (
    <AnimatePresence mode="wait">
      <div key={pathname}>
        ...
        <motion.div className="fixed m-auto top-0 bottom-0 left-0 right-0 text-8xl max-md:text-2xl capitalize z-50 text-white w-fit h-fit" initial={{opacity: 1}} animate={{opacity:0}} exit={{opacity:0}} transition={{duration:0.8, ease:"easeOut"}}>{pathname.substring(1)}</motion.div>
